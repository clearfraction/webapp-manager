...
popd
# _version.py,validate.py,configobj.py,configobj.py
cp -r /usr/lib/python*/site-packages/{pkg_resources,_distutils_hack,setuptools,pygtkcompat,gi,idna,certifi,charset_normalizer,filelock,soupsieve,six.py,urllib3,requests,tldextract,bs4,PIL,setproctitle,usrlocal.pth,requests_file.py} %{buildroot}/usr/lib/webapp-manager/
cp -r %{buildroot}/usr/lib/python*/site-packages/* %{buildroot}/usr/lib/webapp-manager/
